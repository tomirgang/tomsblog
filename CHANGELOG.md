...
- Stakeholder Requirements STK-055 bis STK-059 und Software Requirements SWR-091 bis SWR-095 für fünf neue Features: Logo/FavIcon pro Tenant (STK-055, SWR-091), konfigurierbarer OIDC-Button-Text (STK-056, SWR-092), Benutzer-Löschung über Admin-UI (STK-057, SWR-093), konfigurierbare Standard-Rolle pro Tenant (STK-058, SWR-094), automatisches OIDC-Rollen-Mapping (STK-059, SWR-095)
