...
class TenantSettingsControllerTest {
    ...
    void updateLoginMode() throws Exception {
        var settings = TenantSettings.reconstitute(TENANT_ID, LoginMode.INTERNAL, false, Set.of());
    ...
    void updateAutoApproval() throws Exception {
        var settings = TenantSettings.reconstitute(TENANT_ID, LoginMode.BOTH, true, Set.of("test.com"));
    ...
    void updateAutoApprovalNullDomains() throws Exception {
        var settings = TenantSettings.reconstitute(TENANT_ID, LoginMode.BOTH, false, Set.of());
