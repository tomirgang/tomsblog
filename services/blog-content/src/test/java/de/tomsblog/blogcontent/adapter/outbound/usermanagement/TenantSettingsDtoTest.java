...
class TenantSettingsDtoTest {
    ...
    void hasOidcClientSecretTrue() {
        var dto = new TenantSettingsDto(
                TENANT_ID, "OIDC", false, Set.of(), "Blog", null, null, null, null, null, "secret");
    ...
    void hasOidcClientSecretFalseNull() {
        var dto = new TenantSettingsDto(TENANT_ID, "OIDC", false, Set.of(), "Blog", null, null, null, null, null, null);
    ...
    void hasOidcClientSecretFalseEmpty() {
        var dto = new TenantSettingsDto(TENANT_ID, "OIDC", false, Set.of(), "Blog", null, null, null, null, null, "");
        assertThat(dto.hasOidcClientSecret()).isFalse();
    }
}
