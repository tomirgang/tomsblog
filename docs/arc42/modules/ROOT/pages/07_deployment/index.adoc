...
Redis wird als externer Session-Store für den Blog Content Service eingesetzt (ADR-0030, INF-014). Die HTTP-Sessions werden über Spring Session Data Redis (SWR-057, SWA-032) zentral gespeichert, sodass der Blog Content Service horizontal mit mehreren Replicas betrieben werden kann (STK-045, SWR-058).
