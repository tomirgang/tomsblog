...
Der `BlogViewController` liegt im Package `adapter.inbound.web` und greift über die bestehenden Inbound Ports (`PostUseCase`, `TagUseCase`) auf die Fachlogik zu.
...
* **fragments/header.html**: Seitenkopf mit Blog-Titel und Navigationslinks
