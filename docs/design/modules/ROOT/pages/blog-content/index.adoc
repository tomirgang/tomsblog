...
Er implementiert die Post-CRUD-Operationen (SWR-001), das Veröffentlichen von Posts (SWR-002), Tenant-Isolation (SWR-003), Quellenverwaltung (SWR-012) und den Audit-Trail (SWR-006).

Die Architektur folgt der hexagonalen Architektur (SWA-001) mit einer klaren Trennung von Domain, Application und Adapter Layer.
